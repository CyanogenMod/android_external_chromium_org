...
# that beyond the simple one-level-deep dictionary of values.
{
  'variables': {
    ...
    'net_non_nacl_sources': [
      ...
      'android/libnetxt_network_services.cc',
      'android/libnetxt_network_services.h',
      ...
      'http/http_getzip_bridge.h',
      'http/http_getzip_factory.cc',
      'http/http_getzip_factory.h',
      'http/http_getzip_plugin_ptr.cc',
      'http/http_getzip_plugin_ptr.h',
      ...
      'libnetxt/dyn_lib_loader.cc',
      'libnetxt/dyn_lib_loader.h',
      'libnetxt/dyn_lib_loader_decl.h',
      'libnetxt/libnetxt_base.cc',
      'libnetxt/libnetxt_base.h',
      'libnetxt/plugin_api.cc',
      'libnetxt/plugin_api.h',
      'libnetxt/plugin_api_def.h',
      'libnetxt/plugin_api_ptr.cc',
      'libnetxt/plugin_api_ptr.h',
      'libsta/common/interfaces/origin_server_network_stats.cc',
      'libsta/common/utils/utils.cc',
      'libsta/instance_creation.cc',
      'libsta/instance_creation.h',
      'libsta/sta_libnetxt_plugin_api_ptr.cc',
      'libsta/sta_libnetxt_plugin_api_ptr.h',
      'libsta/transport_service.cc',
      'ocsp/nss_ocsp.cc',
      'ocsp/nss_ocsp.h',
      ...
      'socket/alt_client_socket.cc',
      'socket/alt_client_socket.h',
      'socket/alt_transaction.cc',
      'socket/alt_transaction.h',
      ...
      'socket/tcp_fin_aggregation.h',
      'socket/tcp_fin_aggregation_bridge.cc',
      'socket/tcp_fin_aggregation_bridge.h',
      'socket/tcp_fin_aggregation_factory.cc',
      'socket/tcp_fin_aggregation_factory.h',
      'socket/tcp_fin_aggregation_plugin_ptr.cc',
      'socket/tcp_fin_aggregation_plugin_ptr.h',
      ...
      'stat_hub/pageload_proc.cc',
      'stat_hub/pageload_proc.h',
      'stat_hub/stat_hub.cc',
      'stat_hub/stat_hub_def.h',
      'stat_hub/stat_hub.h',
      'stat_hub/stat_hub_all_api_def.h',
      'stat_hub/stat_hub_api.cc',
      'stat_hub/stat_hub_api.h',
      'stat_hub/stat_hub_cmd.cc',
      'stat_hub/stat_hub_cmd.h',
      'stat_hub/stat_hub_cmd_api.cc',
      'stat_hub/stat_hub_cmd_api.h',
      'stat_hub/stat_hub_cmd_def.h',
      'stat_hub/stat_hub_message_filter.cc',
      'stat_hub/stat_hub_message_filter.h',
      'stat_hub/stat_hub_messages.h',
      'stat_hub/stat_hub_net_plugin_ptr.cc',
      'stat_hub/stat_hub_net_plugin_ptr.h',
    ...
    'net_test_sources': [
      ...
      'stat_hub/stat_hub_unittest.cc',
      'stat_hub/sh_test_plugin.cc',
      'stat_hub/sh_test_plugin.h',
      'test/gtest_util.h',
