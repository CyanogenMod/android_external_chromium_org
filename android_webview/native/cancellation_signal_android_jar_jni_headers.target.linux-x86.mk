...
$(gyp_shared_intermediate_dir)/android_webview/jni/CancellationSignal_jni.h: $(LOCAL_PATH)/base/android/jni_generator/jni_generator.py $(PWD)/prebuilts/sdk/17/android.jar $(GYP_TARGET_DEPENDENCIES)
	@echo "Gyp action: Generating JNI bindings from  $(PWD)/prebuilts/sdk/17/android.jar/android/os/CancellationSignal.class ($@)"
	$(hide)cd $(gyp_local_path)/android_webview/native; mkdir -p $(gyp_shared_intermediate_dir)/android_webview/jni; ../../base/android/jni_generator/jni_generator.py -j "$(PWD)/prebuilts/sdk/17/android.jar" --input_file android/os/CancellationSignal.class --output_dir "$(gyp_shared_intermediate_dir)/android_webview/jni" --optimize_generation 0
