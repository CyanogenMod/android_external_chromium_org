...
$(gyp_shared_intermediate_dir)/ui/gfx/jni/ViewConfiguration_jni.h: $(LOCAL_PATH)/base/android/jni_generator/jni_generator.py $(PWD)/prebuilts/sdk/18/android.jar $(GYP_TARGET_DEPENDENCIES)
	...
	$(hide)cd $(gyp_local_path)/ui/gfx; mkdir -p $(gyp_shared_intermediate_dir)/ui/gfx/jni; ../../base/android/jni_generator/jni_generator.py -j "$(PWD)/prebuilts/sdk/18/android.jar" --input_file android/view/ViewConfiguration.class --output_dir "$(gyp_shared_intermediate_dir)/ui/gfx/jni" --includes base/android/jni_generator/jni_generator_helper.h --optimize_generation 0
