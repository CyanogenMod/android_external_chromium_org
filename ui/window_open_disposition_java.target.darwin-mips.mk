...
LOCAL_MODULE := ui_window_open_disposition_java_gyp
...
$(gyp_shared_intermediate_dir)/templates/org/chromium/ui/WindowOpenDisposition.java: $(LOCAL_PATH)/ui/android/java/WindowOpenDisposition.template $(LOCAL_PATH)/build/android/gyp/util/build_utils.py $(LOCAL_PATH)/build/android/gyp/gcc_preprocess.py $(LOCAL_PATH)/ui/base/window_open_disposition_list.h $(GYP_TARGET_DEPENDENCIES)
	mkdir -p $(gyp_shared_intermediate_dir)/templates/org/chromium/ui; cd $(gyp_local_path)/ui; python ../build/android/gyp/gcc_preprocess.py "--include-path=.." "--output=$(gyp_shared_intermediate_dir)/templates/org/chromium/ui/WindowOpenDisposition.java" "--template=android/java/WindowOpenDisposition.template"

.PHONY: ui_window_open_disposition_java_gyp_rule_trigger
ui_window_open_disposition_java_gyp_rule_trigger: $(gyp_shared_intermediate_dir)/templates/org/chromium/ui/WindowOpenDisposition.java
...
LOCAL_GENERATED_SOURCES := \
	ui_window_open_disposition_java_gyp_rule_trigger
...
gyp_all_modules: ui_window_open_disposition_java_gyp

# Alias gyp target name.
.PHONY: window_open_disposition_java
window_open_disposition_java: ui_window_open_disposition_java_gyp
