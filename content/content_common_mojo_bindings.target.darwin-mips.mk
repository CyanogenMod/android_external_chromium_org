...
$(gyp_shared_intermediate_dir)/content/common/web_ui_setup.mojom.js: $(gyp_shared_intermediate_dir)/content/common/web_ui_setup.mojom.cc ;
$(gyp_shared_intermediate_dir)/content/common/web_ui_setup.mojom-internal.h: $(gyp_shared_intermediate_dir)/content/common/web_ui_setup.mojom.cc ;


GYP_GENERATED_OUTPUTS := \
	$(gyp_shared_intermediate_dir)/content/common/web_ui_setup.mojom.cc \
	$(gyp_shared_intermediate_dir)/content/common/web_ui_setup.mojom.h \
	$(gyp_shared_intermediate_dir)/content/common/web_ui_setup.mojom.js \
	$(gyp_shared_intermediate_dir)/content/common/web_ui_setup.mojom-internal.h

# Make sure our deps and generated files are built first.
LOCAL_ADDITIONAL_DEPENDENCIES := $(GYP_TARGET_DEPENDENCIES) $(GYP_GENERATED_OUTPUTS)

LOCAL_CPP_EXTENSION := .cc
$(gyp_intermediate_dir)/web_ui_setup.mojom.cc: $(gyp_shared_intermediate_dir)/content/common/web_ui_setup.mojom.cc
	mkdir -p $(@D); cp $< $@
LOCAL_GENERATED_SOURCES := \
	$(gyp_intermediate_dir)/web_ui_setup.mojom.cc \
	$(gyp_shared_intermediate_dir)/content/common/web_ui_setup.mojom.h \
	$(gyp_shared_intermediate_dir)/content/common/web_ui_setup.mojom.js \
	$(gyp_shared_intermediate_dir)/content/common/web_ui_setup.mojom-internal.h
