...
include $(LOCAL_PATH)/android_webview/android_webview_jarjar_content_resources.target.darwin-arm.mk
include $(LOCAL_PATH)/android_webview/android_webview_jarjar_ui_resources.target.darwin-arm.mk
...
include $(LOCAL_PATH)/base/base_java_application_state.target.darwin-arm.mk
...
include $(LOCAL_PATH)/cc/blink/cc_blink.target.darwin-arm.mk
...
include $(LOCAL_PATH)/components/pref_registry.target.darwin-arm.mk
include $(LOCAL_PATH)/components/tracing.target.darwin-arm.mk
include $(LOCAL_PATH)/components/user_prefs.target.darwin-arm.mk
include $(LOCAL_PATH)/components/visitedlink_browser.target.darwin-arm.mk
include $(LOCAL_PATH)/components/visitedlink_common.target.darwin-arm.mk
...
include $(LOCAL_PATH)/content/app/resources/content_resources.target.darwin-arm.mk
include $(LOCAL_PATH)/content/app/strings/content_strings.target.darwin-arm.mk
include $(LOCAL_PATH)/content/browser/devtools/devtools_resources.target.darwin-arm.mk
include $(LOCAL_PATH)/content/browser/service_worker/proto.target.darwin-arm.mk
...
include $(LOCAL_PATH)/content/content_app_both.target.darwin-arm.mk
include $(LOCAL_PATH)/content/content_browser.target.darwin-arm.mk
include $(LOCAL_PATH)/content/content_child.target.darwin-arm.mk
include $(LOCAL_PATH)/content/content_common.target.darwin-arm.mk
include $(LOCAL_PATH)/content/content_common_mojo_bindings.target.darwin-arm.mk
include $(LOCAL_PATH)/content/content_gamepad_mapping.target.darwin-arm.mk
include $(LOCAL_PATH)/content/content_gpu.target.darwin-arm.mk
include $(LOCAL_PATH)/content/content_jni_headers.target.darwin-arm.mk
include $(LOCAL_PATH)/content/content_renderer.target.darwin-arm.mk
...
include $(LOCAL_PATH)/content/selection_event_type_java.target.darwin-arm.mk
...
include $(LOCAL_PATH)/gpu/command_buffer_client.target.darwin-arm.mk
...
include $(LOCAL_PATH)/gpu/gpu.target.darwin-arm.mk
include $(LOCAL_PATH)/gpu/gpu_config.target.darwin-arm.mk
include $(LOCAL_PATH)/gpu/gpu_ipc.target.darwin-arm.mk
include $(LOCAL_PATH)/gpu/skia_bindings/gpu_skia_bindings.target.darwin-arm.mk
include $(LOCAL_PATH)/ipc/ipc.target.darwin-arm.mk
include $(LOCAL_PATH)/ipc/mojo/ipc_mojo.target.darwin-arm.mk
include $(LOCAL_PATH)/jingle/jingle_glue.target.darwin-arm.mk
include $(LOCAL_PATH)/media/blink/media_blink.target.darwin-arm.mk
...
include $(LOCAL_PATH)/mojo/mojo_application_bindings.target.darwin-arm.mk
include $(LOCAL_PATH)/mojo/mojo_common_lib.target.darwin-arm.mk
include $(LOCAL_PATH)/mojo/mojo_cpp_bindings.target.darwin-arm.mk
include $(LOCAL_PATH)/mojo/mojo_environment_chromium.target.darwin-arm.mk
include $(LOCAL_PATH)/mojo/mojo_environment_chromium_impl.target.darwin-arm.mk
include $(LOCAL_PATH)/mojo/mojo_js_bindings.target.darwin-arm.mk
include $(LOCAL_PATH)/mojo/mojo_js_bindings_lib.target.darwin-arm.mk
include $(LOCAL_PATH)/mojo/mojo_none.target.darwin-arm.mk
...
include $(LOCAL_PATH)/net/http_server.target.darwin-arm.mk
include $(LOCAL_PATH)/net/net.target.darwin-arm.mk
include $(LOCAL_PATH)/net/net_derived_sources.target.darwin-arm.mk
include $(LOCAL_PATH)/net/net_errors_java.target.darwin-arm.mk
...
include $(LOCAL_PATH)/printing/printing_jni_headers.target.darwin-arm.mk
include $(LOCAL_PATH)/sandbox/sandbox.target.darwin-arm.mk
include $(LOCAL_PATH)/sandbox/sandbox_services.target.darwin-arm.mk
include $(LOCAL_PATH)/sandbox/sandbox_services_headers.target.darwin-arm.mk
include $(LOCAL_PATH)/sandbox/seccomp_bpf.target.darwin-arm.mk
include $(LOCAL_PATH)/sandbox/seccomp_bpf_helpers.target.darwin-arm.mk
...
include $(LOCAL_PATH)/storage/storage.target.darwin-arm.mk
include $(LOCAL_PATH)/storage/storage_common.target.darwin-arm.mk
...
include $(LOCAL_PATH)/third_party/WebKit/Source/bindings/modules/interfaces_info.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/bindings/modules/interfaces_info_individual_modules.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/bindings/modules/modules_core_global_constructors_idls.target.darwin-arm.mk
...
include $(LOCAL_PATH)/third_party/WebKit/Source/bindings/scripts/cached_jinja_templates.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/bindings/scripts/cached_lex_yacc_tables.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/config.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/core/core_event_interfaces.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/core/generate_inspector_protocol_version.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/core/generated_testing_idls.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/core/inspector_instrumentation_sources.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/core/inspector_protocol_sources.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/core/make_core_generated.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/core/webcore.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/core/webcore_dom.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/core/webcore_generated.target.darwin-arm.mk
...
include $(LOCAL_PATH)/third_party/WebKit/Source/core/webcore_svg.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/devtools/build_applications.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/devtools/build_audits_module.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/devtools/build_console_module.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/devtools/build_devices_module.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/devtools/build_documentation_module.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/devtools/build_elements_module.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/devtools/build_extensions_module.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/devtools/build_heap_snapshot_worker_module.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/devtools/build_layers_module.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/devtools/build_network_module.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/devtools/build_profiler_module.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/devtools/build_promises_module.target.darwin-arm.mk
...
include $(LOCAL_PATH)/third_party/WebKit/Source/devtools/supported_css_properties.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/devtools/toolbox_html.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/modules/make_modules_generated.target.darwin-arm.mk
...
include $(LOCAL_PATH)/third_party/WebKit/Source/platform/blink_heap_asm_stubs.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/platform/blink_platform.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/platform/blink_prerequisites.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/platform/make_platform_generated.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/Source/web/blink_web.target.darwin-arm.mk
...
include $(LOCAL_PATH)/third_party/WebKit/public/blink_headers.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/public/blink_minimal.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/WebKit/public/blink_resources.target.darwin-arm.mk
...
include $(LOCAL_PATH)/third_party/boringssl/boringssl.target.darwin-arm.mk
...
include $(LOCAL_PATH)/third_party/leveldatabase/leveldatabase.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libaddressinput/libaddressinput_strings.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libaddressinput/libaddressinput_util.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libevent/libevent.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libjingle/libjingle.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libjingle/libjingle_p2p_constants.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libjingle/libjingle_webrtc.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libjingle/libjingle_webrtc_common.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libjingle/libpeerconnection.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libjpeg_turbo/libjpeg.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libphonenumber/libphonenumber.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libphonenumber/libphonenumber_without_metadata.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libpng/libpng.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libsrtp/libsrtp.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libvpx/gen_asm_offsets_vp8.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libvpx/gen_asm_offsets_vpx_scale.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libvpx/libvpx.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libvpx/libvpx_asm_offsets_vp8.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libvpx/libvpx_asm_offsets_vpx_scale.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libvpx/libvpx_intrinsics_neon.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libvpx/libvpx_obj_int_extract.host.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libwebp/libwebp.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libwebp/libwebp_dec.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libwebp/libwebp_demux.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libwebp/libwebp_dsp.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libwebp/libwebp_dsp_neon.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libwebp/libwebp_enc.target.darwin-arm.mk
...
include $(LOCAL_PATH)/third_party/libyuv/libyuv.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/libyuv/libyuv_neon.target.darwin-arm.mk
...
include $(LOCAL_PATH)/third_party/protobuf/protobuf_full_do_not_use.host.darwin-arm.mk
include $(LOCAL_PATH)/third_party/protobuf/protobuf_lite.target.darwin-arm.mk
...
include $(LOCAL_PATH)/third_party/usrsctp/usrsctplib.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/base/rtc_base.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/base/rtc_base_approved.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/base/webrtc_base.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/common_audio/common_audio.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/common_audio/common_audio_neon.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/common_video/common_video.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/libjingle/xmllite/rtc_xmllite.target.darwin-arm.mk
...
include $(LOCAL_PATH)/third_party/webrtc/modules/audio_device.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/modules/audio_processing.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/modules/audio_processing/gen_aecm_core_neon_offsets_h.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/modules/audio_processing/gen_nsx_core_neon_offsets_h.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/modules/audio_processing/lib_core_neon_offsets.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/modules/audio_processing_neon.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/modules/audioproc_debug_proto.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/modules/bitrate_controller.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/modules/iLBC.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/modules/iSAC.target.darwin-arm.mk
...
include $(LOCAL_PATH)/third_party/webrtc/modules/rtp_rtcp.target.darwin-arm.mk
...
include $(LOCAL_PATH)/third_party/webrtc/modules/video_render_module_impl.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/modules/webrtc_i420.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/modules/webrtc_opus.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/modules/webrtc_utility.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/modules/webrtc_video_coding.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/system_wrappers/source/cpu_features_android.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/system_wrappers/source/system_wrappers.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/video_engine/video_engine_core.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/voice_engine/voice_engine.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/webrtc.target.darwin-arm.mk
include $(LOCAL_PATH)/third_party/webrtc/webrtc_common.target.darwin-arm.mk
...
include $(LOCAL_PATH)/ui/android/bitmap_format_java.target.darwin-arm.mk
include $(LOCAL_PATH)/ui/android/page_transition_types_java.target.darwin-arm.mk
include $(LOCAL_PATH)/ui/android/ui_strings_grd.target.darwin-arm.mk
include $(LOCAL_PATH)/ui/android/window_open_disposition_java.target.darwin-arm.mk
...
include $(LOCAL_PATH)/ui/events/ipc/events_ipc.target.darwin-arm.mk
include $(LOCAL_PATH)/ui/events/platform/events_platform.target.darwin-arm.mk
include $(LOCAL_PATH)/ui/gfx/gfx.target.darwin-arm.mk
include $(LOCAL_PATH)/ui/gfx/gfx_geometry.target.darwin-arm.mk
include $(LOCAL_PATH)/ui/gfx/gfx_jni_headers.target.darwin-arm.mk
include $(LOCAL_PATH)/ui/gfx/ipc/gfx_ipc.target.darwin-arm.mk
...
include $(LOCAL_PATH)/ui/resources/ui_resources.target.darwin-arm.mk
...
include $(LOCAL_PATH)/ui/strings/ui_strings.target.darwin-arm.mk
include $(LOCAL_PATH)/ui/surface/surface.target.darwin-arm.mk
include $(LOCAL_PATH)/url/url_lib.target.darwin-arm.mk
include $(LOCAL_PATH)/v8/tools/gyp/js2c.host.darwin-arm.mk
include $(LOCAL_PATH)/v8/tools/gyp/mksnapshot.host.darwin-arm.mk
...
include $(LOCAL_PATH)/v8/tools/gyp/v8_libplatform.host.darwin-arm.mk
